{
    ...
    'Projections' : {
        ...
        'py_py' : {
            'source' : 'py',
            'target' : 'py',
            'connector' : sim.FixedProbabilityConnector(.02, allow_self_connections=False), #rng=NumpyRNG(1235342134, parallel_safe=False)),
            'synapse_type' : sim.StaticSynapse,
            'weight' : 6e-3,
            'receptor_type' : 'excitatory'
        },
        ...
        're_tc' : {
            'source' : 're',
            'target' : 'tc',
            'connector' : sim.FixedProbabilityConnector(.08, allow_self_connections=False), #rng=NumpyRNG(1235342134, parallel_safe=False)),
            'synapse_type' : sim.StaticSynapse,
            'weight' : 40e-3, #30e-3,
            'receptor_type' : 'inhibitory'
        },
